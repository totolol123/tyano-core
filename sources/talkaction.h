...
typedef std::shared_ptr<TalkAction>       TalkActionP;
typedef std::map<std::string,TalkActionP> TalkActionsMap;
...
class TalkActions : public BaseEvents<TalkAction> {
	public:
		TalkActions();
	...
	private:
		...
		virtual TalkActionP getEvent(const std::string& nodeName);
		virtual bool registerEvent(const TalkActionP& event, xmlNodePtr p, bool override);
...
class TalkAction : public Event
{
	public:
		...
		StringVector getExceptions() {return m_exceptions;}
