...
typedef std::list<boost::intrusive_ptr<Door>> DoorList;
...
{
	public:
		static boost::intrusive_ptr<TransferItem> createTransferItem(House* house);
...
class House
{
	public:
		...
		DoorList::iterator getHouseDoorBegin() {return doorList.begin();}
		DoorList::iterator getHouseDoorEnd() {return doorList.end();}
