...
LOGGER_DEFINITION(ts::item::WeaponKind);


WeaponKind::WeaponKind(const ClassPC& clazz, KindId id)
...
bool WeaponKind::setParameter(const std::string& name, const std::string& value, xmlNodePtr deprecatedNode) {
