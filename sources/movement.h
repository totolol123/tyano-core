...
typedef std::list<MoveEventP> EventList;
...
class MoveEvents : public BaseEvents<MoveEvent>
{
	...
	private:
		...
		virtual MoveEventP getEvent(const std::string& nodeName);
		virtual bool registerEvent(const MoveEventP& event, xmlNodePtr p, bool override);
...
class MoveEvent : public Event
{
	public:
		...
		std::shared_ptr<MoveEvent>       shared_from_this() { return std::static_pointer_cast<MoveEvent>(Event::shared_from_this()); }
		std::shared_ptr<const MoveEvent> shared_from_this() const { return std::static_pointer_cast<const MoveEvent>(Event::shared_from_this()); }
